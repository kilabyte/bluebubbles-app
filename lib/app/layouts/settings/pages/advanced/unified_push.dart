...
class _UnifiedPushPanelState extends CustomState<UnifiedPushPanel, void, UnifiedPushPanelController> {
  final RxBool enabled = SettingsSvc.settings.enableUnifiedPush;
  final RxString endpoint = SettingsSvc.settings.endpointUnifiedPush;
