                      ...
                      Material(
                        ...
                        child: ListView.builder(
                          ...
                          findChildIndexCallback: (key) =>
                              findChildIndexByKey(oneTime, key, (item) => item.id.toString()),
                    ...
                    children: [
                      Material(
                        ...
                        child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          findChildIndexCallback: (key) =>
                              findChildIndexByKey(recurring, key, (item) => item.id.toString()),
                          itemBuilder: (context, index) {
                  ...
                  SettingsSection(
                    ...
                    children: [
                      ListView.builder(
                        ...
                        shrinkWrap: true,
                        findChildIndexCallback: (key) =>
                            findChildIndexByKey(oneTimeCompleted, key, (item) => item.id.toString()),
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              ...
                              style: context.theme.textTheme.bodyMedium!
                                  .copyWith(color: item.status == "error" ? context.theme.colorScheme.error : null),
                            ),
                            trailing: IconButton(
                              icon: Icon(iOS ? CupertinoIcons.trash : Icons.delete_outlined),
                              onPressed: () => deleteMessage(item),
