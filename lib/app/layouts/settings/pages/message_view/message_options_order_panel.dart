...
class _MessageOptionsOrderPanelState extends OptimizedState<MessageOptionsOrderPanel> {
  ...
  Widget build(BuildContext context) {
    final Rx<Color> _backgroundColor =
        (kIsDesktop && SettingsSvc.settings.windowEffect.value != WindowEffect.disabled ? Colors.transparent : context.theme.colorScheme.background).obs;

    final Color tileColor = (ThemeSvc.inDarkMode(context) ? context.theme.colorScheme.properSurface : context.theme.colorScheme.background)
