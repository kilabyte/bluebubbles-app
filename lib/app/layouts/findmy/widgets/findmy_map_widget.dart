...
class FindMyMapWidget extends StatelessWidget {
  ...
  Widget _buildMarkerPopup(BuildContext context, Marker marker) {
    ...
    if (key?.value.contains("device")) {
      final item = controller.devices.firstWhere((e) =>
      ...
      final item = controller.friends.firstWhere(
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
                SettingsSvc.settings.redactedMode.value ? "Device" : (item.name ?? "Unknown Device"),
