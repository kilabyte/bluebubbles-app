...
class ThemeSelectorController extends GetxController {
  ...
  void onInit() {
    ...
    ever(selectedSkin, (_) {
      SettingsSvc.settings.skin.value = Skins.values[selectedSkin.value - 1];
      setMessagesView();
      update();
    });
    super.onInit();
                                        ...
                                        child: FittedBox(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: Theme(
                                                ...
                                                child: Container(
                                                  color: ThemesService.whiteLightTheme.colorScheme.background,
                                                  child: Padding(
                                                      ...
                                                      child: Builder(
                                                          builder: (context) {
                                                            return Scaffold(
                                                                ...
                                                                ), ThemesService.whiteLightTheme) as PreferredSizeWidget?,
                                        ...
                                        child: FittedBox(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: Theme(
                                                ...
                                                child: Container(
                                                  color: ThemesService.oledDarkTheme.colorScheme.background,
                                                  child: Padding(
                                                    padding: const EdgeInsets.only(bottom: 28.0),
                                                    child: Skin(
                                                      skin: Skins.values[controller.selectedSkin.value - 1],
                                                      child: Builder(
                                                          builder: (context) {
                                                            return Scaffold(
                                                                backgroundColor: ThemesService.oledDarkTheme.colorScheme.background,
                                                                appBar: buildConversationViewHeader(context, Chat(
                                                                    id: 69,
                                                                    guid: 'theme-selector',
                                                                    displayName: "Sample Chat",
                                                                ...
                                                                ), ThemesService.oledDarkTheme) as PreferredSizeWidget?,
                                                                body: controller.messagesView
                                                            );
                                                          }
                                                      ),
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Builder(
                                                                  builder: (context) {
                                                                    return Scaffold(
                                                                        backgroundColor: ThemesService.whiteLightTheme.colorScheme.background,
                                                                        appBar: buildConversationViewHeader(context, Chat(
                                                                            id: 69,
                                                                            guid: 'theme-selector',
                                                                            displayName: "Sample Chat",
