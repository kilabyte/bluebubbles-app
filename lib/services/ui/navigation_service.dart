...
import 'package:bluebubbles/core/utils/misc_utils.dart';
...
NavigationService get NavigationSvc =>
    Get.isRegistered<NavigationService>() ? Get.find<NavigationService>() : Get.put(NavigationService());
