...
class MessageUpdateCoordinator extends GetxService {
  ...
  void notifyMessageUpdate(String chatGuid, String messageGuid) {
    ...
    Logger.debug(
      "MessageUpdateCoordinator: Triggered update for message $messageGuid in chat $chatGuid",
      tag: "MessageUpdate"
    );
  }
  ...
  void clearChatUpdates(String chatGuid) {
    ...
    Logger.debug(
      "MessageUpdateCoordinator: Cleared all triggers for chat $chatGuid",
      tag: "MessageUpdate"
    );
  }
  ...
  void clearAll() {
    ...
    Logger.debug(
      "MessageUpdateCoordinator: Cleared all triggers",
      tag: "MessageUpdate"
    );
  }
}
